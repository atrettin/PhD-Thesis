\begin{tikzpicture}
    \pgfplotstableread{figures/icecube/classification/variables/reco_length.csv}\table
    \begin{groupplot}[
    ...
    \nextgroupplot[
        ...
        legend columns=3,
        ymode=log,
        ymin=4.270878113916398e-09, ymax=0.02178785334987359,
        ylabel=rate (Hz),
        ...
        y filter/.expression={y < 4.270878113916398e-09 ? ln(4.270878113916398e-10) : ln(y)}
    ]
