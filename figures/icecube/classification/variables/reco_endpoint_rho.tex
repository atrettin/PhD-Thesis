\begin{tikzpicture}
    \pgfplotstableread{figures/icecube/classification/variables/reco_endpoint_rho.csv}\table
    \begin{groupplot}[
    ...
    \nextgroupplot[
        ...
        legend columns=3,
        ymode=log,
        ymin=1.537329690962227e-09, ymax=0.030170606564090804,
        ylabel=rate (Hz),
        ...
        y filter/.expression={y < 1.537329690962227e-09 ? ln(1.537329690962227e-10) : ln(y)}
    ]
