\begin{tikzpicture}
    \pgfplotstableread{figures/icecube/classification/variables/reco_vertex_rho.csv}\table
    \begin{groupplot}[
    ...
    \nextgroupplot[
        ...
        legend columns=3,
        ymode=log,
        ymin=1.3571484754903132e-08, ymax=0.013445978221463655,
        ylabel=rate (Hz),
        ...
        y filter/.expression={y < 1.3571484754903132e-08 ? ln(1.3571484754903133e-09) : ln(y)}
    ]
