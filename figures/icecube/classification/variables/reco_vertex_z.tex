\begin{tikzpicture}
    \pgfplotstableread{figures/icecube/classification/variables/reco_vertex_z.csv}\table
    \begin{groupplot}[
        xmin=-729.0,xmax=-91.0,
        xmode=normal,
    ...
    \nextgroupplot[
        ...
        legend columns=3,
        ymode=log,
        ymin=1.5415881903160668e-10, ymax=0.016993782549797515,
        ylabel=rate (Hz),
        ...
        y filter/.expression={y < 1.5415881903160668e-10 ? ln(1.5415881903160668e-11) : ln(y)}
    ]
