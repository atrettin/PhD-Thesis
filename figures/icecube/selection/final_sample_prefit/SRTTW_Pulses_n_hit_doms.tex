\tikzsetnextfilename{final_level_prefit_srttw_pulses_n_hit_doms}%
\begin{tikzpicture}
    ...
    \nextgroupplot[
        ...
        legend columns=3,
        ymode=log,
        ymin=3.0832748839276883e-10, ymax=0.0011670550686361785,
        ylabel=rate (Hz),
        ...
        y filter/.expression={y < 3.0832748839276883e-10 ? ln(3.0832748839276883e-11) : ln(y)}
    ]
