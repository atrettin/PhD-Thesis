\tikzsetnextfilename{final_level_prefit_reco_length}%
\begin{tikzpicture}
    ...
    \nextgroupplot[
        ...
        legend columns=3,
        ymode=log,
        ymin=5.654377442601027e-10, ymax=0.001966007294480835,
        ylabel=rate (Hz),
        ...
        y filter/.expression={y < 5.654377442601027e-10 ? ln(5.6543774426010275e-11) : ln(y)}
    ]
