\begin{tikzpicture}
    \pgfplotstableread{reco_vertex_z.csv}\table
    \begin{groupplot}[
    ...
    \nextgroupplot[
        ...
        legend columns=3,
        ymode=log,
        ymin=2.0000000000000002e-11, ymax=0.00264093629799649,
        ylabel=rate (Hz),
    ...
    \node[anchor=south] at (axis description cs:0.5, 0.1) {$\chi^2_{\mathrm{mod}}/\mathrm{dof} = 2.23$};
    \end{groupplot}
\end{tikzpicture}
