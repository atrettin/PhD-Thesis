\tikzsetnextfilename{pika}%
\begin{tikzpicture}[x=.4in, y=.4in]
...
\tikzset{
	...
	\fill [glare, path fading={circle with fuzzy edge 20 percent}] (.1,-.1) circle [radius=.1];
	},
}
...
(1.2,5.5)
.. controls (1.5,5.2) and (1.7,5.3) .. (1.1,)
-- cycle;
\fill [deep green]
(7,4) -- (4,3) -- (2.2,4.9)
