...
After the application of all these cuts, the data sample consists of 21,914 well-reconstructed, track-like events with an expected background from atmospheric muons of only $\sim 2\%$ as shown in \reftab{muon-rejection-cut-rates}.\todo{write somewhere which flux model is assumed}
