...
As described in \refsec{antineutrino-scattering}, the only distinction between the interactions of neutrinos and antineutrinos is a difference in inelasticity and total cross-section that is due to their spin configuration.\todo{continue to explain that we cannot distinguish nu from antinu}
