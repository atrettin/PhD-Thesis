...
In this section, we describe how this bias can be corrected to linear order.
...
The reason why this set of variables is sufficient is that we \emph{implicitly marginalize} over all variables that we don't include.
