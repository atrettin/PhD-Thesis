...
A summary of the effects of neutrinos on cosmological observations can be found in \sidecite{Lesgourgues_2014}.\todo{expand explanation a bit}
...
Neutrino oscillations are the only known phenomenon beyond the Standard Model to date that is confirmed experimentally to a very high statistical significance\todo{several citations needed in this section}\todo{one round of editing for this section}.
...
This can be seen, for example, in the MSW resonance condition in \refeq{msw-condition}, where the sign of $\cos{2\vartheta}$ is directly degenerate with the sign of $\delta m^2$.
