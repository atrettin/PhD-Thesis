...
It is also possible to build a model with a small but non-zero left-handed Majorana mass, $M^L$, that replaces the zero in the upper left corner of the mass matrix in \refeq{dm-mass-matrix}.
